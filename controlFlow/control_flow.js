...
let authenticationStatus = isAuthenticated ? "Authenticated" : "Not authenticated"; // If isAuthenticated = true it prints "Authenticated", if false it prints "Not authenticated"
