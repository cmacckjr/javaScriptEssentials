...
// You need to create an authorization-based code to provide access to people based on their roles in organization, such as employees, enrolled members for "Dietary Services," and subscribers.
...
switch (userRole) {
    case "Employee":
        authorizationStatus = "Access granted to 'Dietary Services'";
        break;
    case "Enrolled Member":
        authorizationStatus = "Access granted to 'Dietary Services' and 1-on-1 interaction with a dietician";
        break;
    case "Subscriber":
        authorizationStatus = "Partial access granted to facilitate 'Dietary Services' only";
        break;
    case "Non-Subscriber":
        authorizationStatus = "Need to enroll or at least subscribe first to avail this facility";
        break;
    default:
        authorizationStatus = "Unknown";
}
console.log("Authorization Level:", authorizationStatus);